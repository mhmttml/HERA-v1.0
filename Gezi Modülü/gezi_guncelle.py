from PyQt6.QtWidgets import QDialog, QVBoxLayout, QLabel, QLineEdit, QPushButton, QHBoxLayout, QGraphicsDropShadowEffect, QDateEdit, QCalendarWidget, QWidget, QComboBox, QGridLayout, QTableWidget, QTableWidgetItem, QHeaderView, QAbstractItemView, QMessageBox
...
class GeziGuncelleDialog(QDialog):
    def __init__(self, parent=None, gezi_data=None):
        super().__init__(parent)
        self.setWindowTitle("Gezi Bilgilerini Güncelle")
    ...
    def init_ui(self):
        ...
        # Başlık
        title = QLabel("Gezi Bilgilerini Güncelle")
        ...
        self.gezi_id_edit.setText(self.gezi_data.get('id', ''))
        ...
        """)
        self.gezi_adi_edit.setText(self.gezi_data.get('adi', ''))
        ...
        """)
        self.baslangic_edit.setText(self.gezi_data.get('baslangic', ''))
        ...
        """)
        self.bitis_edit.setText(self.gezi_data.get('bitis', ''))
        ...
        """)
        self.ucret_edit.setText(self.gezi_data.get('ucret', ''))
        ...
        """)
        self.min_participant_edit.setText(self.gezi_data.get('katilimci', ''))
        ...
        """)
        self.max_participant_edit.setText(self.gezi_data.get('max_katilimci', ''))
        ...
        """)
        # Seçili lideri ayarla
        current_lider = self.gezi_data.get('lider', '')
        index = self.lider_combo.findText(current_lider)
        if index >= 0:
            self.lider_combo.setCurrentIndex(index)
        ...
        current_durum = self.gezi_data.get('durum', '')
        index = self.durum_combo.findText(current_durum)
        if index >= 0:
        ...
        """)
        self.adres_edit.setText(self.gezi_data.get('adres', ''))
        ...
        """)
        self.aciklama_edit.setText(self.gezi_data.get('aciklama', ''))
        ...
        """)
        self.organizator_edit.setText(self.gezi_data.get('organizator', ''))
        ...
        """)
        self.plaka_edit.setText(self.gezi_data.get('plaka', ''))
        ...
        self.export_btn.setFont(QFont("Arial", 16, QFont.Weight.DemiBold))
        ...
        self.export_btn.setFixedSize(180, 55)
    ...
    def export_data(self):
        """Gezi verilerini dışarı aktar"""
        QMessageBox.information(self, "Bilgi", "Gezi verileri dışarı aktarıldı!")

    def get_gezi_data(self):
        """Güncellenmiş gezi verilerini döndür"""
        return {
